...
cwd = "../study1_build/images/"

savefolder = "."
#     datafolder = "img"
# if method = "deepcluster":

# #     # cwd = "/home/han/Data/instagram-yilang/" # replace with your own folder path
# #     img_cluster_sample"
# #     datafolder = "img"


results = open("resnet50 KMeans 2742 10.txt", 'r').readlines()
# # results = open("assignment_protest_AlexNet.txt", 'r').readlines()


# # joint-cluster-cnn; politicians
# # results = open("/home/han/Codes/joint-cluster-cnn/cluster_labels.txt", 'r').readlines()


# # original, pre-trained, using Kmeans and VGG
# results = open("/home/han/Dropbox/Collaborations/with_Yilang_Peng/YP protest/img clustering/vgg-4096 KMeans 2742 10.txt", 'r').readlines()


# # savefolder = "img_cluster/deepcluster"
# #savefolder = "img_cluster/joint-cluster-cnn"

# # cwd1 = "/home/han/Data/instagram-yilang/"
# # savefolder = "protest_cluster/deepcluster"
# # savefolder = "protest_cluster/joint-cluster-cnn"
...
for K in range(6,7):
    ...
    large_savepath = os.path.join(savefolder,  architecture + "_" + cluster_method + "_K=" + str(K)+".png")
