...
if __name__ == '__main__':
    ...
    file = "protest_ARCH=alexnet_K=6_EPOCH=500_label_distance.txt"
    ...
    # files = ['/home/han/Dropbox/Collaborations/with_Yilang_Peng/YP protest/img clustering/labels/protest_ARCH=vgg16_K=6_EPOCH=425_label_gaussianmixture.txt']
